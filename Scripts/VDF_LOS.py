...
B_snaps = ['1.0_0_000', '1.0_5_005', '1.0_10_005', '1.0_198_000', '1.0_198_093', '1.0_199_093']
...
E_snaps = ['1.0_0_000', '1.0_5_005', '1.0_10_005', '1.0_160_005', '1.05_196_005',
           '0.95_197_005', '1.0_198_009', '1.0_198_093']
...
if keep_IC_R_middle:
    if F.startswith('HQ10000_G'):
        {-1.5: 10 ** -.70, -2.0: 10 ** -.25,
         -2.5: 10 ** -.0, -3.0: 10 ** -.30}.get(Gamma, "No such gamma value")
    if F.startswith('OM_'):
