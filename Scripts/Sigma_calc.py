...
def kappa_func(len_obj=sigma2_arr, radii=bin_radius_arr, sigma_r2=sigmarad2_arr):
    '''
    Calculate kappa
    '''
...
def gamma_func(radii=bin_radius_arr, density=density_arr, len_obj_1=density,
               len_obj_2=sigma2_arr):
    '''
    Calculate gamma
    '''
    for i in range(len(len_obj_1)):
        if i in (0, len(len_obj_2) - 1):
