...
if Fig3_sigma_over_v_circ_r_2:  # Dispersions
    ...
    plt.plot(x_plot, y_plot, 'c--^', ms=8, mew=0, label=r'$\log(\bar{\sigma_{\tan}}^2)$')
    plt.xlabel(r'$\log(\frac{r}{r_{-2}})$', fontsize=30)
...
if Fig4_beta:  # plot beta
    ...
    if Fig4_betafit:  # fitting beta with two different profiles
        ...
        fig_names_I_R32 = ['A_IC_beta_logr_I_R32', 'A_48_009_beta_logr_I_R32',
                           'A_48_009_beta_logr_I_R32_cuts',
                           'B_IC_beta_logr_I_R32', 'B_199_093_beta_logr_I_R32',
                           'Soft_B_IC_beta_logr_I_R32',
                           'Soft_B_Final_beta_logr_I_R32',
                           'CS1_IC_beta_logr_I_R32', 'CS4_IC_beta_logr_I_R32',
                           ...
                           'D2_beta_logr_I_R32', 'D2_49_093_beta_logr_I_R32',
                           'Soft_D2_beta_logr_I_R32',
                           'Soft_D2_49_093_beta_logr_I_R32',
                           'E_beta_logr_I_R32', 'E_198_093_beta_logr_I_R32']
...
if Fig5_kappa:
    ...
    if Fig5_kappafit:  # fitting beta with two different profiles
        ...
        print('y_plot.shape = ', y_plot.shape, 'len(y_plot) = ', len(y_plot),
              'y_plot[1.] = ', y_plot[1.])
        plt.plot(x_plot[0:len(y_plot) - 3], y_plot[0:len(y_plot) - 3],
                 'b-', ms=2, mew=0, label='Analytical shape')
...
if Fig6_gamma:
    ...
    if Fig6_gammafit:
        ...
        title_params = namedtuple('title_params',
                                  ['sim', 'snapshot', 'Rlimit', 'bins'])
        ...
        fig_names_I_32 = ['A_IC_gamma_logr_I_R32', 'A_48_009_gamma_logr_I_R32',
                          'A_48_009_gamma_logr_I_R32_cuts',
                          'A_48_009_gamma_r_I_R32', 'B_IC_gamma_logr_I_R32',
                          'B_199_093_gamma_logr_I_R32',
                          'Soft_B_IC_gamma_logr_I_R32',
                          'Soft_B_Final_gamma_logr_I_R32',
                          'CS1_IC_gamma_logr_I_R32', 'CS2_IC_gamma_logr_I_R32',
                          'CS3_IC_gamma_logr_I_R32', 'CS4_IC_gamma_logr_I_R32',
