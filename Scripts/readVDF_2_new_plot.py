...
if Fig5d_GPerts_gammas_3_0_vt_divided_by_gauss_and_Tsallis:
    ...
    if A:
        ...
        ax5.set_ylim(0.5, 1.5)
        ax5.set_ylabel(
            r"$\frac{f\left( u \right)}{887.569 \cdot x \cdot e^{-0.922 \cdot x^2}}$", fontsize=20)
    ...
    if B:
        ...
        ax4.set_ylabel(
            r"$\log \left( f\left(\log \left( |u_n|,u_p \right)\right) \right)$", fontsize=20)
        ax4.set_yscale("log")
...
if Fig6b_GPerts_R_middle_31_62_vt_divided_by_gauss_and_Tsallis:
    ...
    if test:
        ...
        ax6.set_ylabel(
            r"$\frac{f\left(\log \left( |u_n|,u_p \right)\right)}{e^{-0.5x^2}}$", fontsize=20)
